                ...
                {member.socialLinks && (
                  <div className="flex justify-center gap-2 mt-4">
                    {member.socialLinks.facebook && sanitizeExternalUrl(member.socialLinks.facebook) && (
                      <a href={sanitizeExternalUrl(member.socialLinks.facebook) || undefined} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-[var(--on-surface-muted)] hover:text-brand-500 hover:bg-brand-50 dark:hover:bg-brand-950/30 transition-colors" aria-label="Facebook">
                    ...
                    {member.socialLinks.instagram && sanitizeExternalUrl(member.socialLinks.instagram) && (
                      <a href={sanitizeExternalUrl(member.socialLinks.instagram) || undefined} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-[var(--on-surface-muted)] hover:text-brand-500 hover:bg-brand-50 dark:hover:bg-brand-950/30 transition-colors" aria-label="Instagram">
                    ...
                    {member.socialLinks.linkedin && sanitizeExternalUrl(member.socialLinks.linkedin) && (
                      <a href={sanitizeExternalUrl(member.socialLinks.linkedin) || undefined} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-[var(--on-surface-muted)] hover:text-brand-500 hover:bg-brand-50 dark:hover:bg-brand-950/30 transition-colors" aria-label="LinkedIn">
                    ...
                    {member.socialLinks.tiktok && sanitizeExternalUrl(member.socialLinks.tiktok) && (
                      <a href={sanitizeExternalUrl(member.socialLinks.tiktok) || undefined} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-[var(--on-surface-muted)] hover:text-brand-500 hover:bg-brand-50 dark:hover:bg-brand-950/30 transition-colors" aria-label="TikTok">
